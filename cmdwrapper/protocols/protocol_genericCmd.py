...
class GenericCmdProtocol(EMProtocol):
    ...
    def _defineParams(self, form):
        ...
        form.addParam('command', params.StringParam,
                      ...
                      help='Which command should be executed. Particle sets can '
                           ...
                           'need to follow the patterns defined at the Outputs section . $WORKING_DIR points'
    ...
    def executeCmd(self):
        ...
        project_dir = self.getProject().getPath()
        cmd = cmd.replace("$WORKING_DIR", project_dir+"/")
